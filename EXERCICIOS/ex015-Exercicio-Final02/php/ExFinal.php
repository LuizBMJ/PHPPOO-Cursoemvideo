...
class Visualizacao {
    ...
    public function avaliar($valor = null, $tipo = null) {

        // avaliar sem parâmetros (padrão)
        if ($valor === null) {
            $this->filme->setAvaliacao(5);
        }

        // avaliar com nota direta
        elseif ($tipo === "nota") {
            $this->filme->setAvaliacao($valor);
        }

        // avaliar por porcentagem assistida
